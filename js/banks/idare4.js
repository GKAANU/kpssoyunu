...
/* ---------- İL GENEL MECLİSİ DENETİM YOLLARI ---------- */
{
  q: "İl genel meclisi bilgi edinme ve denetim yetkisini hangi yollarla kullanır?",
  o: ["Soru, genel görüşme ve faaliyet raporunu değerlendirme", "Soru, gensoru ve genel görüşme", "Sadece soru", "Gensoru ve denetim komisyonu", "Meclis araştırması ve soruşturma"],
  a: 0,
...
},
{
  ...
  o: ["Mart ayı toplantısında sunar; üye tam sayısının dörtte üç çoğunluğuyla yeterli görülmezse tutanak İçişleri Bakanlığına gönderilir", "Ocak ayında sunar; tutanak Danıştay'a gönderilir", "Eylül ayında sunar; vali görevden düşer", "Mart ayında sunar; vali görevden düşer", "Kasım ayında sunar"],
  a: 0,
...
},
{
  ...
  o: ["Meclis çalışabilir duruma gelinceye veya yeni seçim yapılıncaya kadar encümenin memur üyeleri", "Vali tek başına", "İçişleri Bakanlığı", "İl idare kurulu", "Danıştay"],
  a: 0,
...
},
{
  ...
  o: ["3 yıldan fazla kiralanmasına il genel meclisi, süresi 3 yılı geçmemek üzere kiralanmasına il encümeni karar verir", "Her türlü kiralamaya vali karar verir", "Her türlü kiralamaya il encümeni karar verir", "5 yıldan fazlasına meclis karar verir", "Kiralama yetkisi sadece meclise aittir"],
  a: 0,
...
},
{
  ...
  o: ["Beş bin Türk Lirasına kadar olan ihtilaflarda", "On bin Türk Lirasına kadar", "Bin Türk Lirasına kadar", "Sınırsız", "Elli bin Türk Lirasına kadar"],
  a: 0,
...
},
{
  ...
  o: ["Kurumsal kodlama yapılan birimler ile fonksiyonel sınıflandırmanın birinci düzeyleri arasında aktarma il genel meclisi, ikinci düzeyleri arasında aktarma il encümeni tarafından yapılır", "Tüm aktarmalar vali tarafından yapılır", "Tüm aktarmalar il encümeni tarafından yapılır", "Tüm aktarmalar il genel meclisi tarafından yapılır", "Aktarma yapılamaz"],
  a: 0,
...
/* ---------- İL GENEL MECLİSİ KARARLARININ KESİNLEŞMESİ ---------- */
{
  q: "İl genel meclisi kararları kaç gün içinde valiye gönderilir ve vali hukuka aykırı bulursa ne yapar?",
  o: ["Karar 5 gün içinde valiye gönderilir; vali hukuka aykırı bulursa 7 gün içinde yeniden görüşülmesi için iade edebilir", "Karar 7 gün içinde gönderilir, vali 5 gün içinde iade edebilir", "Karar 10 gün içinde gönderilir", "Karar doğrudan yürürlüğe girer", "Vali kararı doğrudan iptal edebilir"],
  a: 0,
...
/* ---------- İL ÖZEL İDARESİ BÜTÇESİ ---------- */
{
  ...
  o: ["Vali hazırlar, eylül ayı başında il encümenine sunar; encümen inceleyip görüş bildirir ve kasım ayının birinci gününden önce il genel meclisine sunar; meclis aynen veya değiştirerek kabul eder", "İl genel meclisi hazırlar, vali onaylar", "İl encümeni hazırlar, vali kabul eder", "Vali hazırlar ve doğrudan uygular", "İçişleri Bakanlığı hazırlar"],
  a: 0,
...
/* ---------- İL ÖZEL İDARESİNİN DENETİMİ ---------- */
{
  q: "İl özel idaresi hizmetlerinin ciddi biçimde aksatıldığı nasıl belirlenir?",
  o: ["İlgili bakanlığın talebi üzerine yetkili sulh hukuk hâkimi tarafından", "Vali tarafından", "İçişleri Bakanlığı tarafından", "Danıştay tarafından", "İl genel meclisi tarafından"],
  a: 0,
...
},
{
  ...
  o: ["Hizmetin yerine getirilmesini o ilin valisinden ister; vali önce il özel idaresinin kaynaklarıyla, mümkün olmazsa diğer kamu kurumlarının imkânlarıyla giderir", "İl özel idaresini kapatır", "Doğrudan hizmeti kendisi yürütür", "Danıştay'a başvurur", "Hiçbir şey yapamaz"],
  a: 0,
...
},
{
  ...
  o: ["Köy ihtiyar meclisinin kararı veya seçmenlerinin en az yarısından bir fazlasının mahallin en büyük mülki idare amirine yazılı başvurusu ya da valinin kendiliğinden gerek görmesi durumunda", "Sadece köy ihtiyar meclisinin kararıyla", "Sadece valinin talebiyle", "Sadece İçişleri Bakanlığının kararıyla", "Halkoylaması yapılmaz"],
  a: 0,
...
},
{
  ...
  o: ["İçme ve kullanma suyu havzaları ile sit ve diğer koruma alanlarında ve meskûn sahası kurulu bir belediyenin sınırlarına 5.000 metreden daha yakın olan yerleşim yerlerinde", "Sadece sit alanlarında", "Nüfusu 10.000'in altındaki yerlerde", "Orman köylerinde", "Büyükşehir sınırları içinde"],
  a: 0,
...
},
{
  ...
  o: ["Belediye meclisi üye tam sayısının en az dörtte üç çoğunluğunun kararı ve valinin görüşü üzerine İçişleri Bakanlığının onayı ile", "Sadece belediye meclisi kararıyla", "Cumhurbaşkanı kararıyla", "Salt çoğunlukla alınan meclis kararı ve vali onayı ile", "TBMM kararıyla"],
  a: 0,
...
},
{
  ...
  o: ["2.000'in altına düşen belediyeler Cumhurbaşkanı kararı ile", "5.000'in altına düşen belediyeler", "1.000'in altına düşen belediyeler", "3.000'in altına düşen belediyeler", "Belediyeler köye dönüştürülemez"],
  a: 0,
...
/* ---------- BELEDİYENİN GÖREVLERİ ---------- */
{
  ...
  o: ["İmar, su ve kanalizasyon, ulaşım gibi kentsel altyapı; zabıta, itfaiye, acil yardım, kurtarma ve ambulans; defin ve mezarlıklar", "Devlete ait okul binalarının inşaatı", "Sağlıkla ilgili her türlü tesisi açmak ve işletmek", "Gıda bankacılığı yapmak", "Amatör spor kulüplerine yardım yapmak"],
  a: 0,
...
},
{
  ...
  o: ["Büyükşehir belediyeleri ile nüfusu 100.000'in üzerindeki belediyeler", "Tüm belediyeler", "Sadece büyükşehir belediyeleri", "Nüfusu 50.000'in üzerindeki belediyeler", "Nüfusu 10.000'in üzerindeki belediyeler"],
  a: 0,
...
/* ---------- BELEDİYE MECLİSİ ---------- */
{
  ...
  o: ["Belde nüfusunun büyüklüğüne göre 9 ila 55 arasında değişir; meclise belediye başkanı başkanlık eder", "Sabit 31 üyedir; meclis kendi başkanını seçer", "9 ila 45 arasındadır; meclis başkanını seçer", "Nüfusa göre değişmez; başkan vali tarafından atanır", "15 ila 55 arasındadır; encümen başkanlık eder"],
  a: 0,
...
},
{
  ...
  o: ["Belediye başkanı tarafından belirlenir ve en az üç gün önceden üyelere bildirilir", "Meclis başkan vekili tarafından", "Encümen tarafından", "Vali tarafından", "Meclis üyelerinin oyuyla"],
  a: 0,
...
},
{
  ...
  o: ["Üye tam sayısının salt çoğunluğuyla toplanır ve katılanların salt çoğunluğuyla karar verir; karar yeter sayısı üye tam sayısının dörtte birinden az olamaz", "2/3 çoğunlukla toplanır", "Karar yeter sayısı üye tam sayısının yarısıdır", "Kararlar oybirliğiyle alınır", "Üye tam sayısının 1/3'ü ile toplanır"],
  a: 0,
...
},
{
  ...
  o: ["Kanunla verilen görevleri ihmal edip işleri aksatırsa veya görevleriyle ilgisi olmayan siyasi konularda karar alırsa, İçişleri Bakanlığının bildirimi üzerine Danıştay kararıyla", "Vali kararıyla", "Cumhurbaşkanı kararıyla", "İçişleri Bakanının doğrudan kararıyla", "Sayıştay kararıyla"],
  a: 0,
...
/* ---------- BELEDİYE MECLİSİ DENETİM YOLLARI ---------- */
{
...
},
{
  ...
  o: ["Üye tam sayısının en az üçte biri imzasıyla verilir, salt çoğunlukla gündeme alınır ve üç tam gün geçmedikçe görüşülemez; dörtte üç çoğunlukla güvensizlik oyu verilirse tutanak valiye, vali tarafından Danıştay'a gönderilir", "Salt çoğunlukla verilir ve derhal görüşülür", "Üye tam sayısının yarısı imzasıyla verilir", "Güvensizlik oyu salt çoğunlukla verilir", "Gensoru sonucu başkan doğrudan düşer"],
  a: 0,
...
},
{
  ...
  o: ["Üye tam sayısının dörtte üç çoğunluğuyla yeterli görülmezse tutanak meclis başkan vekili tarafından mülki idare amirine, vali tarafından gerekçeli görüşle Danıştay'a gönderilir; Danıştay uygun görürse başkan düşer", "Doğrudan başkan düşer", "Tutanak İçişleri Bakanlığına gönderilir ve başkan düşer", "Salt çoğunlukla yeterli görülmezse başkan düşer", "Herhangi bir sonuç doğurmaz"],
  a: 0,
...
},
{
  ...
  o: ["İl ve ilçe belediyeleri ile nüfusu 10.000'in üzerindeki belediyelerde, her ocak ayı toplantısında üç ile beş üye arasında", "Tüm belediyelerde, beş üyeden", "Sadece büyükşehir belediyelerinde", "Nüfusu 50.000'in üzerindeki belediyelerde", "Her mart ayı toplantısında yedi üyeden"],
  a: 0,
...
/* ---------- BELEDİYE ENCÜMENİ ---------- */
{
  ...
  o: ["Yedi kişiden: başkan, meclisin seçeceği üç üye, mali hizmetler birim amiri ve başkanın seçeceği iki üye", "Beş kişiden", "Dokuz kişiden", "Üç kişiden", "On bir kişiden"],
  a: 0,
...
},
{
  ...
  o: ["Beş kişiden: başkan, meclisin seçeceği iki üye, mali hizmetler birim amiri ve başkanın seçeceği bir üye", "Yedi kişiden", "Üç kişiden", "Dört kişiden", "Dokuz kişiden"],
  a: 0,
...
},
{
  ...
  o: ["Belediye başkanının görevlendireceği başkan yardımcısı veya encümen üyesi", "Mali hizmetler birim amiri", "Meclis başkan vekili", "En kıdemli encümen üyesi", "Vali"],
  a: 0,
...
},
{
  ...
  o: ["Kanunlarda öngörülen cezaları ve ruhsatları vermek, umuma açık yerlerin açılış ve kapanış saatlerini belirlemek", "Borçlanmaya karar vermek", "İmar planlarını onaylamak", "Yönetmelikleri kabul etmek", "Fahri hemşehrilik payesi vermek"],
  a: 0,
...
/* ---------- BELEDİYE BAŞKANI ---------- */
{
  ...
  o: ["Siyasi partilerin yönetim ve denetim organlarında görev alamaz; profesyonel spor kulüplerinin başkanlığını yapamaz ve yönetiminde bulunamaz", "Hiçbir kısıtlamaya tabi değildir", "Sadece siyasi parti üyesi olamaz", "Ticari faaliyette bulunamaz", "Sadece profesyonel spor kulübünde görev alamaz"],
  a: 0,
...
},
{
  ...
  o: ["Belediye meclisi üyeleri arasından görevlendireceği başkan vekili; başkan vekili başkanın yetkilerine sahiptir", "Belediye başkan yardımcısı", "Mali hizmetler birim amiri", "En kıdemli encümen üyesi", "Vali tarafından atanan bir kişi"],
  a: 0,
...
/* ---------- BELEDİYE İŞBÖLÜMÜ ---------- */
{
  ...
  o: ["30 yılı geçmemek üzere (3 yıldan fazla kiralamaya da karar verir)", "25 yılı geçmemek üzere", "10 yılı geçmemek üzere", "49 yılı geçmemek üzere", "Süre sınırı yoktur"],
  a: 0,
...
},
{
  ...
  o: ["Fahri hemşehrilik payesi ve beratı vermek, meydan-cadde-sokak-park adı vermek ve belediye başkanı ile encümen arasındaki anlaşmazlıkları karara bağlamak", "Kanunlarda öngörülen ruhsatları vermek", "Umuma açık yerlerin açılış-kapanış saatlerini belirlemek", "Öngörülmeyen giderler ödeneğinin harcama yerlerini belirlemek", "Belediye personelini atamak"],
  a: 0,
...
},
{
  ...
  o: ["Belediye personelini atamak, şartsız bağışları kabul etmek, temsil ve ağırlama giderleri için ayrılan ödeneği kullanmak", "Şartlı bağışları kabul etmek", "Yönetmelikleri kabul etmek", "Borçlanmaya karar vermek", "İmar planlarını onaylamak"],
  a: 0,
...
/* ---------- BELEDİYE MECLİSİ KARARLARININ KESİNLEŞMESİ ---------- */
{
  q: "Belediye başkanı meclis kararını hukuka aykırı bulursa ne yapabilir ve meclis ısrar ederse süreç nasıl işler?",
  o: ["5 gün içinde yeniden görüşülmesi için iade edebilir; meclis üye tamsayısının salt çoğunluğuyla ısrar ederse karar kesinleşir ve başkan 10 gün içinde idari yargıya başvurabilir", "7 gün içinde iade eder; meclis ısrar ederse karar iptal olur", "Kararı doğrudan iptal edebilir", "İade edemez", "İçişleri Bakanlığına gönderir"],
  a: 0,
...
},
{
  ...
  o: ["Kesinleştiği tarihten itibaren en geç 7 gün içinde mahallin en büyük mülki idare amirine; gönderilmeyen kararlar yürürlüğe girmez", "15 gün içinde İçişleri Bakanlığına", "5 gün içinde valiye", "30 gün içinde Danıştay'a", "Gönderilmesi gerekmez"],
  a: 0,
...
/* ---------- BELEDİYENİN DENETİMİ ---------- */
{
  q: "Belediye hizmetlerindeki aksama giderilemezse ortaya çıkan maliyet nasıl karşılanır?",
  o: ["Maliyet vali tarafından İller Bankasına bildirilir ve o belediyenin müteakip ay genel bütçe vergi gelirleri payından valilik emrine gönderilir", "Belediye bütçesinden doğrudan ödenir", "İçişleri Bakanlığı bütçesinden ödenir", "Hazine tarafından karşılanır", "Maliyet karşılanmaz"],
  a: 0,
...
},
{
  ...
  o: ["Söz konusu hizmeti Yatırım İzleme ve Koordinasyon Başkanlığı, il özel idaresi veya kamu kurum ve kuruluşları aracılığıyla yapar veya yaptırır", "Belediyeyi kapatır", "Sadece İçişleri Bakanlığına bildirir", "Belediye meclisini fesheder", "Hiçbir şey yapamaz"],
  a: 0,
...
},
{
  ...
  o: ["Mahallin en büyük mülki idare amiri", "Cumhuriyet savcısı", "İçişleri Bakanı", "Sulh hukuk hâkimi", "Belediye meclisi"],
  a: 0,
...
/* ---------- BELEDİYE BÜTÇESİ ---------- */
{
  ...
  o: ["Başkan hazırlar ve eylül ayının birinci gününden önce encümene sunar; encümen inceleyip görüş bildirir ve kasım ayının birinci gününden önce meclise sunar; meclis aynen veya değiştirerek kabul eder", "Meclis hazırlar, başkan onaylar", "Encümen hazırlar, meclis kabul eder", "Başkan hazırlar ve doğrudan uygular", "Vali hazırlar, meclis kabul eder"],
  a: 0,
